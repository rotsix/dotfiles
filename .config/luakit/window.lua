...
window.methods = {
    ...
    close_tab = function (w, view, blank_last)
        ...
        if blank_last ~= false and w.tabs:count() == 1 then
            if not view:loading() and view.uri == "file:///home/victor/.config/homePage/index.html" then return end
            w:new_tab("file:///home/victor/.config/homePage/index.html", false)
            w.has_blank = true
        end
        -- Save tab history
