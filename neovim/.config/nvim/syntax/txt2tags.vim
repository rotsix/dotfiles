...
" Maintainer: yt
" Last change: 2012-4-24 - v2.1,add some colors
...
hi link t2tTitle1         Error
"add by ytao
hi link t2tTitle2         Error
hi link t2tTitle3         Error
hi link t2tTitle4         Error
hi link t2tTitle5         Error

hi link t2tNumTitle1      Error
hi link t2tNumTitle2      Error
hi link t2tNumTitle3      Error
hi link t2tNumTitle4      Error
hi link t2tNumTitle5      Error
"add by ytao before
...
hi	t2tTitle1	guifg=red	gui=bold	
hi	t2tTitle3	guifg=darkgreen	gui=bold	
hi	t2tTitle2	guifg=lightblue	gui=bold	
hi	t2tTitle4	guifg=brown	gui=bold	
hi	t2tTitle5	guifg=yellow	gui=bold
hi  t2tTitleMark guifg=lightgrey
...
syn match t2tNumTitle1 '^ *\(+\{1}\)[^+]\(\|.*[^+]\)\1\(\[[a-z0-9_-]*\]\)\=\s*$' contains=t2tNumTitleMark,t2tTitleRef
syn match t2tNumTitle2 '^ *\(+\{2}\)[^+]\(\|.*[^+]\)\1\(\[[a-z0-9_-]*\]\)\=\s*$' contains=t2tNumTitleMark,t2tTitleRef
syn match t2tNumTitle3 '^ *\(+\{3}\)[^+]\(\|.*[^+]\)\1\(\[[a-z0-9_-]*\]\)\=\s*$' contains=t2tNumTitleMark,t2tTitleRef
syn match t2tNumTitle4 '^ *\(+\{4}\)[^+]\(\|.*[^+]\)\1\(\[[a-z0-9_-]*\]\)\=\s*$' contains=t2tNumTitleMark,t2tTitleRef
syn match t2tNumTitle5 '^ *\(+\{5}\)[^+]\(\|.*[^+]\)\1\(\[[a-z0-9_-]*\]\)\=\s*$' contains=t2tNumTitleMark,t2tTitleRef

hi	t2tNumTitle1	guifg=red	gui=bold
hi	t2tNumTitle3	guifg=darkgreen	gui=bold
hi	t2tNumTitle2	guifg=lightblue	gui=bold
hi	t2tNumTitle4	guifg=brown	gui=bold
hi	t2tNumTitle5	guifg=yellow	gui=bold	
hi  t2tNumTitleMark guifg=darkgrey

hi t2tTable guibg=lightgrey
hi t2tTableTit guibg=lightgrey  guifg=darkblue  gui=bold
hi t2tTableBar guibg=lightgrey  guifg=blue
hi t2tTableMark guibg=lightgrey guifg=blue
hi t2tTableAlign guibg=lightgrey guifg=darkblue
