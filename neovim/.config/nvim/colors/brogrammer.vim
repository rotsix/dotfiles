...
hi Normal ctermfg=231 ctermbg=231 cterm=NONE guifg=#ecf0f1 guibg=#1a1a1a gui=NONE
...
hi NonText ctermfg=22 ctermbg=NONE cterm=NONE guifg=#30312a guibg=#1a1a1a gui=NONE
